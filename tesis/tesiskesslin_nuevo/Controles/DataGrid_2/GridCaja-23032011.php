...
$FuncionFinal="$FuncionG('$ValFun1','$ValFun2','$ValFun3','$ValFun4','$ValFun5','$ValFun6','$ValFun7','$ValFun8','$ValFun9','$ValFun10','$ValFun11','$ValFun12','$ValFun13','$ValFun14','$ValFun15','$ValFun16','$ValFun17','$ValFun18','$ValFun19','$ValFun20','$ValFun21','$ValFun22','$ValFun23','$ValFun24','$ValFun25')";				
	...
	#SWTICH QUE CREA EL TIPO DE CAMPO A PINTAR
	 switch($TipoC){	//0:TextoNormal, 1:Check, 2:Text, 3:Combo, 4:Options, 5:Boton, 6:Ver.., 7:Link, 8:codicionales
		case 1:	
		$TipoCG="<input name=\"$CampoSinAlias\" id=\"$CampoSinAlias\" type=\"checkbox\" value=\"$CampoSinAlias\"  onclick=\"$FuncionFinal\"/>";
		break;
		case 2:
		$TipoCG="<input name=\"$CampoSinAlias\" type=\"text\" style=\"width:99%\" value=\"stripslashes(".$row_grid->$CampoSinAlias.")\" />";
		break;
		case 4:
		$TipoCG="<input name=\"$CampoSinAlias\" onclick=\"$FuncionFinal\" type=\"radio\" value=\"$CampoSinAlias\" />";
		break;
		case 5:
		$TipoCG="<input name=\"$CampoSinAlias\" type=\"button\" style=\"width:100%\" value=\"".$row_grid->$CampoSinAlias."\" onclick=\"$FuncionFinal\"/>";
		break;
		case 6:
		$TipoCG="<input name=\"$CampoSinAlias\" type=\"button\" style=\"width:100%\" value=\"Ver..\" onclick=\"$FuncionFinal\"/>";
		break;
		case 7:
