...
(function ($) {
  ...
  $.fn.extend({
    ...
    //ESTA FUNCION SE CREO PARA NO ESCRIBIR EN CADA ARCHIVO LO MISMO
    GeneraCodigo = function(code,IdDiv,Tipo){
            var tipo = Tipo||'code128';
            var configuracion = {
              output:'css',//css
            ...
            jQuery('#'+IdDiv).barcode(code,tipo,configuracion); 
    }
}(jQuery));